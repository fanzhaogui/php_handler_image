...
class Avatar
{
    ...
    private $size;
    private $imgInfo;
    protected $savePath = "/grafika/handler-img/";

    /**
     * Avatar constructor.
     * @param $fileName 文件的绝对路径， 或相对路径
     * @param $rgb 颜色索引 数组 array(255, 255, 0) 或 16进制
     * @param $size 图像的大小
     * @throws Exception
     */
    ...
    public function show()
    {
        ...
        // 创建图像
        imagepng($imgbk, "./grafika/handler-img/lena.".date("YmdHis")."png");
        // 销毁资源
        imagedestroy($imgbk);
        imagedestroy($imgfk);
        imagedestroy($shadow);
